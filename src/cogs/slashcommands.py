...
class SlashCommands(commands.Cog):
    ...
    @nextcord.slash_command(guild_ids=TESTING_GUILD_IDS, description="Simple slash command.")
    ...
    async def my_slash_command(self, interaction: nextcord.Interaction):
        return await interaction.response.send_message("This is a slash command in a cog!")
    ...
    async def bot_info(self, interaction: nextcord.Interaction):
        e = nextcord.Embed(title=self.bot.user.display_name,
    ...
    async def alexlol(self, interaction: nextcord.Interaction, arg: str = nextcord.SlashOption(description="Hallo.")):
